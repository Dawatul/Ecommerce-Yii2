	...
	<div class="container">
		<div class="banner-main">
			<div class="col-md-6 banner-left">
				<a href="single.html"><img src="<?= $url ?>/bg2.jpg" alt="" class="img-responsive"></a>
			</div>
			<div class="col-md-6 banner-right simpleCart_shelfItem">
				<h2>Roses</h2>
				<h1>Tanaman Hias</h1>
				<h5 class="item_price">$39.900</h5>
				<ul class="bann-btns">
	...
	<div class="container">
		<div class="blc-layer3-main">
			   ...
			   <div class="col-md-4 blc-layer3-grids2">
			   	<a href="single.html"><img src="<?= $url ?>/bracelate.png" alt=""></a>
			   </div>
			   <div class="col-md-4 blc-layer3-grids-3 simpleCart_shelfItem">
				 <div class="box-grid">
				   	...
				   	<a href="single.html"><img src="<?= $url ?>/w2.png" alt=""></a>
	...
	<div class="container">
		<div class="home-block-main">
			<div class="col-md-3 home-grid">
				<div class="home-product-main">
				   <div class="home-product-top">
				      <a href="product.html"><img src="<?= $url ?>/h1.jpg" alt="" class="img-responsive zoom-img"></a>
				   </div>
			...
			<div class="col-md-3 home-grid">
				<div class="home-product-main">
				   <div class="home-product-top">
				      <a href="product.html"><img src="<?= $url ?>/h2.jpg" alt="" class="img-responsive zoom-img"></a>
				   </div>
					<div class="home-product-bottom">
							<h3><a href="single.html">Smart Shopping</a></h3>
							<p>Explore Now</p>						
			...
			<div class="col-md-3 home-grid">
				<div class="home-product-main">
				   <div class="home-product-top">
				      <a href="product.html"><img src="<?= $url ?>/h3.jpg" alt="" class="img-responsive zoom-img"></a>
				   </div>
					<div class="home-product-bottom">
							<h3><a href="single.html">Smart Shopping</a></h3>
							<p>Explore Now</p>						
			...
			<div class="col-md-3 home-grid">
				<div class="home-product-main">
				   <div class="home-product-top">
				      <a href="product.html"><img src="<?= $url ?>/h4.jpg" alt="" class="img-responsive zoom-img"></a>
				   </div>
					<div class="home-product-bottom">
							<h3><a href="single.html">Smart Shopping</a></h3>
							<p>Explore Now</p>						
