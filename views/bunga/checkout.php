			...
			<div class="in-check" >
				...
				<ul class="cart-header simpleCart_shelfItem">
					<div class="close1"> </div>
						<li class="ring-in"><a href="single.html" ><img src="<?= $url ?>3a.jpg" class="img-responsive" alt=""></a>
						</li>
						<li><span>Mandevilla</span></li>
						<li><span class="item_price">$ 55.000</span></li>
						<li> <a href="#" class="add-cart cart-check item_add">Add to cart</a></li>				
					<div class="clearfix"> </div>
				</ul>
				<ul class=" cart-header1 simpleCart_shelfItem">
					<div class="close2"> </div>
						<li class="ring-in"><a href="single.html" ><img src="<?= $url ?>3b.jpg" class="img-responsive" alt=""></a>
						</li>
						<li><span>Gelombang Cinta</span></li>
						<li><span class="item_price">$ 35.000</span></li>
						<li> <a href="#" class="add-cart cart-check item_add">Add to cart</a></li>						
						<div class="clearfix"> </div>
			</div>
			</div>  
