					 ...
					 <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
					        <ul class="nav navbar-nav">
					        	   <li><a href="index.html">Home</a></li>
						            ...
						            <li class="dropdown">
						        	<?= Html::a('Tanaman Merambat', ['/bunga/product']) ?>
						            <ul class="dropdown-menu multi-column columns-3">
							            <div class="row">
								            <div class="col-sm-4">
									            <ul class="multi-column-dropdown">
						        ...
						        <li><?= Html::a('Contact', ['/bunga/contact']) ?>
					        </ul>
					    </div>
					    <!--/.navbar-collapse-->
					</nav>
			...
			<div class="header-right">
				<div class="search">
					...
					<div class="cart box_1">
						...
						<h3>
							<img src="<?= $url ?>cart.png" alt=""/>
							<div class="total">
							<span class="simpleCart_total"></span></div>
							</h3>
						</a>
						<li><?= Html::a('Checkout', ['/bunga/checkout']) ?>
					</div>                 
		...
		<div class="product-main">
			  ...
			  <div class="col-md-9 product-block">
			      <div class="col-md-4 home-grid">
					<div class="home-product-main">
					   <div class="home-product-top">
					      <a href="single.html"><img src="<?= $url ?>1b.jpg" alt="" class="img-responsive zoom-img"></a>
					   </div>
						<div class="home-product-bottom">
								<h3><a href="single.html">Mandevilla</a></h3>
								<p>Explore Now</p>						
						</div>
						<div class="srch">
							<span>$55.000</span>
			      ...
			      <div class="col-md-4 home-grid">
					<div class="home-product-main">
					   <div class="home-product-top">
					      <a href="single.html"><img src="<?= $url ?>1c.jpg" alt="" class="img-responsive zoom-img"></a>
					   </div>
						<div class="home-product-bottom">
								<h3><a href="single.html">Morning Glory</a></h3>
								<p>Explore Now</p>						
						</div>
						<div class="srch">
							<span>$50.000</span>
			     ...
			     <div class="col-md-4 home-grid">
					<div class="home-product-main">
					   <div class="home-product-top">
					      <a href="single.html"><img src="<?= $url ?>1d.jpg" alt="" class="img-responsive zoom-img"></a>
					   </div>
						<div class="home-product-bottom">
								<h3><a href="single.html">Bougenville</a></h3>
								<p>Explore Now</p>						
						</div>
						<div class="srch">
							<span>$25.000</span>
			      ...
			      <div class="col-md-4 home-grid">
					<div class="home-product-main">
					   <div class="home-product-top">
					      <a href="single.html"><img src="<?= $url ?>1e.jpg" alt="" class="img-responsive zoom-img"></a>
					   </div>
						<div class="home-product-bottom">
								<h3><a href="single.html">Air Mata Pengantina</h3>
								<p>Explore Now</p>						
						</div>
						<div class="srch">
							<span>$51.000</span>
			      ...
			      <div class="col-md-4 home-grid">
					<div class="home-product-main">
					   <div class="home-product-top">
					      <a href="single.html"><img src="<?= $url ?>1f.jpg" alt="" class="img-responsive zoom-img"></a>
					   </div>
						<div class="home-product-bottom">
								<h3><a href="single.html">Pothos Scandens</a></h3>
								<p>Explore Now</p>						
						</div>
						<div class="srch">
							<span>$69.000</span>
			      ...
			      <div class="col-md-4 home-grid">
					<div class="home-product-main">
					   <div class="home-product-top">
					      <a href="single.html"><img src="<?= $url ?>1g.jpg" alt="" class="img-responsive zoom-img"></a>
					   </div>
						<div class="home-product-bottom">
								<h3><a href="single.html">Arumdalu</a></h3>
								<p>Explore Now</p>						
						</div>
						<div class="srch">
							<span>$25.000</span>
			      ...
			      <div class="col-md-4 home-grid">
					<div class="home-product-main">
					   <div class="home-product-top">
					      <a href="single.html"><img src="<?= $url ?>1h.jpg" alt="" class="img-responsive zoom-img"></a>
					   </div>
						<div class="home-product-bottom">
								<h3><a href="single.html">Flame of Irian</a></h3>
								<p>Explore Now</p>						
						</div>
						<div class="srch">
							<span>$80.000</span>
			      ...
			      <div class="col-md-4 home-grid">
					<div class="home-product-main">
					   <div class="home-product-top">
					      <a href="single.html"><img src="<?= $url ?>1i.jpg" alt="" class="img-responsive zoom-img"></a>
					   </div>
						<div class="home-product-bottom">
								<h3><a href="single.html">Patrea Volubilis</a></h3>
								<p>Explore Now</p>						
						</div>
						<div class="srch">
							<span>$67.000</span>
			      ...
			      <div class="col-md-4 home-grid">
					<div class="home-product-main">
					   <div class="home-product-top">
					      <a href="single.html"><img src="<?= $url ?>1j.jpg" alt="" class="img-responsive zoom-img"></a>
					   </div>
						<div class="home-product-bottom">
								<h3><a href="single.html">Zabrina Pendula</a></h3>
								<p>Explore Now</p>						
						</div>
						<div class="srch">
							<span>$54.000</span>
