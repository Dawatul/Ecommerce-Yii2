		...
		<div class="product-main">
			  ...
			  <div class="col-md-9 product-block">
			      <div class="col-md-4 home-grid">
					<div class="home-product-main">
					   <div class="home-product-top">
					      <a href="single.html"><img src="<?= $url ?>2a.jpg" alt="" class="img-responsive zoom-img"></a>
					   </div>
						<div class="home-product-bottom">
								<h3><a href="single.html">Daun Puring</a></h3>
								<p>Explore Now</p>						
						</div>
						<div class="srch">
							<span>$50.000</span>
			      ...
			      <div class="col-md-4 home-grid">
					<div class="home-product-main">
					   <div class="home-product-top">
					      <a href="single.html"><img src="<?= $url ?>2b.jpg" alt="" class="img-responsive zoom-img"></a>
					   </div>
						<div class="home-product-bottom">
								<h3><a href="single.html">Pucuk Merah</a></h3>
								<p>Explore Now</p>						
						</div>
						<div class="srch">
							<span>$15.000</span>
			     ...
			     <div class="col-md-4 home-grid">
					<div class="home-product-main">
					   <div class="home-product-top">
					      <a href="single.html"><img src="<?= $url ?>2c.jpg" alt="" class="img-responsive zoom-img"></a>
					   </div>
						<div class="home-product-bottom">
								<h3><a href="single.html">Gelombang Cinta</a></h3>
								<p>Explore Now</p>						
						</div>
						<div class="srch">
							<span>$35.000</span>
			      ...
			      <div class="col-md-4 home-grid">
					<div class="home-product-main">
					   <div class="home-product-top">
					      <a href="single.html"><img src="<?= $url ?>2d.jpg" alt="" class="img-responsive zoom-img"></a>
					   </div>
						<div class="home-product-bottom">
								<h3><a href="single.html">Calathea Black Lipstik</a></h3>
								<p>Explore Now</p>						
						</div>
						<div class="srch">
							<span>$105.000</span>
			      ...
			      <div class="col-md-4 home-grid">
					<div class="home-product-main">
					   <div class="home-product-top">
					      <a href="single.html"><img src="<?= $url ?>2e.jpg" alt="" class="img-responsive zoom-img"></a>
					   </div>
						<div class="home-product-bottom">
								<h3><a href="single.html">Monstera</a></h3>
								<p>Explore Now</p>						
						</div>
						<div class="srch">
							<span>$45.000</span>
			      ...
			      <div class="col-md-4 home-grid">
					<div class="home-product-main">
					   <div class="home-product-top">
					      <a href="single.html"><img src="<?= $url ?>2f.jpg" alt="" class="img-responsive zoom-img"></a>
					   </div>
						<div class="home-product-bottom">
								<h3><a href="single.html">Lili Paris</a></h3>
								<p>Explore Now</p>						
						</div>
						<div class="srch">
							<span>$20.000</span>
			      ...
			      <div class="col-md-4 home-grid">
					<div class="home-product-main">
					   <div class="home-product-top">
					      <a href="single.html"><img src="<?= $url ?>2g.jpg" alt="" class="img-responsive zoom-img"></a>
					   </div>
						<div class="home-product-bottom">
								<h3><a href="single.html">Sirih Gading</a></h3>
								<p>Explore Now</p>						
						</div>
						<div class="srch">
							<span>$28.000</span>
			      ...
			      <div class="col-md-4 home-grid">
					<div class="home-product-main">
					   <div class="home-product-top">
					      <a href="single.html"><img src="<?= $url ?>2h.jpg" alt="" class="img-responsive zoom-img"></a>
					   </div>
						<div class="home-product-bottom">
								<h3><a href="single.html">Spider Plant</a></h3>
								<p>Explore Now</p>						
						</div>
						<div class="srch">
							<span>$25.000</span>
			      ...
			      <div class="col-md-4 home-grid">
					<div class="home-product-main">
					   <div class="home-product-top">
					      <a href="single.html"><img src="<?= $url ?>2i.jpg" alt="" class="img-responsive zoom-img"></a>
					   </div>
						<div class="home-product-bottom">
								<h3><a href="single.html">Kadaka</a></h3>
								<p>Explore Now</p>						
						</div>
						<div class="srch">
							<span>$35.000</span>
