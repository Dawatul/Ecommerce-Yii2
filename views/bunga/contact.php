	...
	<div class="container">
		<div class="contact-main">
			...
			<div class="col-md-6 contact-left">
			    ...
			    <ul>
			    	<li><span class="glyphicon glyphicon-map-marker" aria-hidden="true"> </span>Lamongan, East Java</li>
			    	<li><span class="glyphicon glyphicon-phone" aria-hidden="true"> </span>+62 858 1658 7550</li>			    	
			    	<li><span class="glyphicon glyphicon-envelope" aria-hidden="true"> </span><a href="mailto:info@example.com">kdwatul@gmail.com</a></li>
			    </ul>
			</div>
